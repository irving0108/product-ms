...
/**
 * Controller que expone los servicios del productType.
...
public class ProductTypeController {
    ...
    public Mono<ProductType> updateProductType(@PathVariable("id") Integer id, 
    ...
    public ResponseEntity<Mono<ProductType>> findById(@PathVariable("id") Integer id){
        ...
        return new ResponseEntity<Mono<ProductType>>(productmono, productmono != null ? 
    ...
    public Mono<ProductType> delete(@PathVariable("id") Integer id) {
        ...
        return productService.findByProductTypeId(id).switchIfEmpty(Mono.empty())
                .filter(Objects::nonNull).flatMap(productToBeDeleted -> productService
